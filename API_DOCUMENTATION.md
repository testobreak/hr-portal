...
> **DTO Schema Reference Guide**: Complete request/response payload definitions and realistic business JSON examples are available in [SCHEMA_DOCUMENTATION.md](file:///Users/ashish/Downloads/hr-portal-main/SCHEMA_DOCUMENTATION.md) and [docs/SCHEMA_REFERENCE.md](file:///Users/ashish/Downloads/hr-portal-main/docs/SCHEMA_REFERENCE.md).
